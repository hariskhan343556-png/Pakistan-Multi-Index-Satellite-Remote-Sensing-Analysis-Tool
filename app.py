...
try:
    ...
    st.error(
        ...
        "This usually means a package in requirements.txt did not install, or the "
        "'modules' folder is missing from the deployed repository. Check "
        "'Manage app -> Logs' on Streamlit Cloud for the pip install output, and "
        "confirm requirements.txt matches the project's requirements.txt exactly."
    )
    st.stop()
